	...
	<div>
					...
					<div class="card input-group-addon">
						<div class="card-body">
							<%
								...
								if (dto.getTitle()!= null && dto.getId() > 0) {
							%>
							...
							%>
							<h3 class="text-center default-text text-primary">ADD Book</h3>
							<%
								}
							%>
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>Book Title:</b> <span
								...
								</font> </br> <span class="pl-sm-5"><b>Author:</b> <span
									style="color: red;">*</span></span> </br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="author"
											...
											value="<%=DataUtility.getStringData(dto.getAuthor())%>">
									</div>
								</div>

								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("author", request)%>
								</font> </br> <span class="pl-sm-5"><b>Price:</b> <span
									style="color: red;">*</span></span> </br>
								...
								</font> </br> <span class="pl-sm-5"><b>Publication Year:</b> <span
									style="color: red;">*</span></span> </br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="publicationYear"
											...
											value="<%=DataUtility.getStringData(dto.getPublicationYear())%>">
									</div>
								</div>

								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("publicationYear", request)%>
								</font> </br>
		</main>
		...
		<div class="text-center" style="margin-top: -25px;">
			...
			<input type="submit" name="operation" class="btn btn-success btn-md"
				style="font-size: 17px" value="<%=BookCtl.OP_UPDATE%>"> <input
		...
		<div class="text-center" style="margin-top: -25px;">
			...
			<input type="submit" name="operation" class="btn btn-success btn-md"
				style="font-size: 17px" value="<%=BookCtl.OP_SAVE%>"> <input
				type="submit" name="operation" class="btn btn-warning btn-md"

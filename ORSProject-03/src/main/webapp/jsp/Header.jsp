    ...
    <%}%>">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<%=ORSView.MARKSHEET_CTL%>"><i
							...
							class="fa fa-paste"></i>Marksheet List <a class="dropdown-item"
							href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>"><i
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"
					style="color: green;">Time Table</a>
					<div class="dropdown-menu">
				...
				<%-- <li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu">
						...
						</a> <a class="dropdown-item" href="<%=ORSView.EMI_CTL%>"> <i
							class="fa fa-id-card"></i> Add EMI
						</a> <a class="dropdown-item" href="<%=ORSView.EMI_LIST_CTL%>"> <i
							class="fa fa-sort-amount-down"></i> EMI List
						</a> <a class="dropdown-item" href="<%=ORSView.PARKING_CTL%>"> <i
							class="fa fa-id-card"></i> Add Parking
						</a> <a class="dropdown-item" href="<%=ORSView.PARKING_LIST_CTL%>">
							<i class="fa fa-sort-amount-down"></i> Parking List
						</a> <a class="dropdown-item" href="<%=ORSView.ASSET_CTL%>"> <i
							class="fa fa-id-card"></i> Add Asset
						</a> <a class="dropdown-item" href="<%=ORSView.ASSET_LIST_CTL%>">
							<i class="fa fa-sort-amount-down"></i> Asset List
						</a>

...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.BOOK_LIST_CTL%>" method="post">
			...
			<center>
				<h1 class="text-dark font-weight-bold pt-3">
					<font color="blue">Book List</font>
				</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=BookListCtl.OP_SEARCH%>">&emsp; <input
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=dto.getPublicationYear()%></td>
							<td><a href="<%=ORSView.BOOK_CTL%>?id=<%=dto.getId()%>">
			...
			<table width="100%">
				...
				<tr>
					...
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" value="<%=BookListCtl.OP_DELETE%>"></td>
